            ...
            <div className="bg-white rounded-xl relative" key={event._id}>
              ...
              <div className='rounded-tl-[0.75rem] rounded-tr-[0.75rem] rounded-br-[0] rounded-bl-[0] object-fill aspect-16:9 relative'>
                {event.image ? (
                  <img
                    ...
                    width="300" 
                    height="200" 
                    className="w-full h-full rounded-tl-[0.75rem] rounded-tr-[0.75rem] object-cover"
                  />
                ) : (
                  <div className='w-full h-full rounded-tl-[0.75rem] rounded-tr-[0.75rem] bg-gray-100 flex items-center justify-center'>
              ...
              <div className="m-2 grid gap-2">
                <div className="flex justify-between items-center">
                  <h1 className="font-bold text-lg mt-2">{event.title ? event.title.toUpperCase() : ''}</h1>
                ...
                <div className="flex text-sm flex-nowrap justify-between text-primarydark font-bold mr-4">
                  ...
                  <div>{event.ticketPrice === 0? 'Free' : event.ticketPrice.toLocaleString() + ' VND'}</div>
                </div>
                ...
                <div className="flex justify-between items-center my-2 mr-4">
                  ...
                  <div className="text-sm text-primarydark ">Created By: <br/> <span className="font-semibold">
                    {event.owner?.name || event.organizedBy || 'Unknown'}
                  </span></div>
                </div>
